...
;thuoc tinh cua ran va game  
    letadd dw 1700, 2000,2500,1800,3764,1612,6 Dup(0) ;display addresses of collectable letters, this is being displayed and updated during the game play
    dletadd dw 1700, 2000,2500,1800,3764,1612,6 Dup(0) ;default values for collectable letters addresses on display to return them back after reset the game
    letnum db 6 ;number of collectable letters
    fin db 6 ;to track the number of collectable letters
    hlth db 10 ;/2 ;health count which is 5 in this case 
    
    ;Snake Info            
    sadd dw 07D2h,7 Dup(0) ;address of the first letter on the display and this will be updated during game play and will add each letter address after collecting
    snake db '+',7 Dup(0) ;Collected letters array
